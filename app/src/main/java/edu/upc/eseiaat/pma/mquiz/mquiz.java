package edu.upc.eseiaat.pma.mquiz;
...
public class mquiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current_question < all_questions.length - 1) {
                    ...
                    Toast.makeText(mquiz.this, resultado, Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
        ...
        //Perimer els atributs amb els recursos i despres executar el showquestion, ja que els necesites.
        //showQuestion();
    }
